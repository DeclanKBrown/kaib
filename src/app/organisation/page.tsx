                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col justify-center pb-3 px-5">
                        <div className="w-full flex flex-col gap-5">
                            ...
                            <Link href='/organisation/join' className="relative flex h-12 items-center justify-between rounded-md px-5 text-center text-base font-medium bg-gradient-to-b from-zinc-200 to-zinc-100 backdrop-blur-2xl border border-1 border-zinc-300 hover:border hover:border-1 hover:border-zinc-400">
