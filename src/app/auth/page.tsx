...
export default function Auth() {
    ...
    return (
        <div className="flex min-h-full w-screen flex-col sm:supports-[min-height:100dvh]:min-h-[100dvh] md:grid md:grid-cols-2 lg:grid-cols-[60%_40%]">
            <div className="relative hidden flex-1 flex-col justify-center px-5 pt-8 bg-gradient-to-b from-zinc-200 backdrop-blur-2xl md:flex md:px-6 md:py-[22px] lg:px-8">
                ...
                <div className="flex items-center justify-center">
                    <h1 className="text-center text-[28px] leading-[1.2] md:text-[28px] md:leading-8 select-none">Knowledge Base AI</h1>
                </div>
            </div>
