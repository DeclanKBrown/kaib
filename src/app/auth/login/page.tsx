                    ...
                    <div className="flex flex-col justify-center pb-3 px-5">
                        <div className="w-full">
                            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                                <input type="email" name="email" autoComplete="off" className="border border-zinc-300 rounded-md h-12 pl-4 outline-none focus:border-[#3C46FF]" placeholder="email"></input>
